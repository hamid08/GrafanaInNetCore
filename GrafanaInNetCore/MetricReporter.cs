...
namespace GrafanaInNetCore
{
    public class MetricReporter
    {
        ...
        public MetricReporter(ILogger<MetricReporter> logger)
        {
            ...
            _requestCounter =
                Metrics.CreateCounter("hamid_total_requests", "The total number of requests serviced by this API.");

            _responseTimeHistogram = Metrics.CreateHistogram("hamid_request_duration_seconds",
